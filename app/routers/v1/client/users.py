...
from app.databases.events.schema import UserSchema
...
user_model =api.model('User',{
                            ...
                            'phone':fields.Integer(required=True,description="Número de telefone"),
                            'zip_code':fields.Integer(required=True,description="CEP da cidade."),
                            ...
                            'cpf':fields.String(required=True,description="Identificação CPF"),
...
class Phisycal(Resource):
    ...
    def post(self,**kwargs):
        ...
        if erros:return {"error":True,"message":"Algo deu errado.",
                            "details":{"erros":erros}},201

        return {"message":'Tudo certo'},200
